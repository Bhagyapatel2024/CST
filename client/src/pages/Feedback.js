...
const styles = {
  ...
  input: {
    ...
    // border: '1px solid #ccc',
    color: '#fff',  // Set text color to white
    backgroundColor: '#333',  // Set input background to dark
  },
  textarea: {
    padding: '10px',
    fontSize: '16px',
    ...
    // border: '1px solid #ccc',
    color: '#fff',  // Set text color to white
    backgroundColor: '#333',  // Set textarea background to dark
    height: '100px',
  },
  button: {
    padding: '10px 20px',
  ...
  successBox: {
    ...
    backgroundColor: '#333',  // Dark background for success box
    borderRadius: '5px',
    textAlign: 'center',
  },
  successMessage: {
  ...
  feedbackIdBox: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: '#444',  // Darker background for feedback ID box
    padding: '10px',
    borderRadius: '5px',
  },
  copyButton: {
